...
type CreateAgentParams struct {
	...
	MessageInstructions      interface{} `json:"message_instructions"`
}
...
UPDATE agent SET
    ...
    message_instructions = COALESCE($13, message_instructions),
...
type UpdateAgentParams struct {
	...
	MessageInstructions      pgtype.Text `json:"message_instructions"`
	CustomEnv                []byte      `json:"custom_env"`
	CustomArgs               []byte      `json:"custom_args"`
	McpConfig                []byte      `json:"mcp_config"`
	Model                    pgtype.Text `json:"model"`
